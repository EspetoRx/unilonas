...
class PostController extends Controller
{
    ...
    {
        $armazenamento = Storage::disk('gcs');
        return view('dashboard.posts.create', compact('armazenamento'), [
    ...
    public function store(StorePostRequest $request)
    {
        ...
        if ($request->has('draft')) {
            return redirect()->route('dashboard.posts.draft')->with('success', 'Publicação salva.');
        }

        return redirect()->route('posts.show', $post->id)->with('success', 'Publicação efetuada.');
    }
    ...
    // Abort if the post is drafted and the user does not have the right to manage posts
        ...
        $armazenamento = Storage::disk('gcs');
        return view('posts.show', compact('armazenamento'), [
    ...
    public function edit(Post $post)
    {
        ...
        $armazenamento = Storage::disk('gcs');
        return view('dashboard.posts.edit', compact('armazenamento'), [
    ...
    public function update(StorePostRequest $request, Post $post)
    {
        ...
        // Flash alert message
        session()->flash('post_update', 'Publicação efetuada.');
    ...
    public function destroy(Post $post)
    {
        ...
        return redirect()->route('dashboard.posts.index')->with('success', 'Publicação movida para a lixeira.');
    }
    ...
    public function restore(Post $post)
    {
        ...
        $post->restore();
        return redirect()->back()->with('success', 'Publicação restaurada.');
    }
    ...
    public function forceDeleteAll(Request $request)
    {
        ...
        return redirect()->back()->with('success', 'Lixeira vazia.');
    }
