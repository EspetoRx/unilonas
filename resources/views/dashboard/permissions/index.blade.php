...
<div class="container-fluid">
  ...
  <div class="d-flex justify-content-between mb-3">
    <h1 class="page-heading">Permissões</h1>

    @can('manage permissions')
    <div id="app">
      <modal title="New permission" button-text="Nova permissão">
        <v-form inline-template route="/api/permissions" success-message="Permissão criada!">
    ...
    <table class="table table-borderless fs-14 mb-0">
      ...
      <tbody>
        ...
        <tr scope="row">
          ...
          <td>
            {{-- Edit --}}
            <a href="{{ route('dashboard.permissions.edit', $permission->id) }}" class="btn btn-link btn-sm c-666 p-0" data-toggle="tooltip" data-placement="top" title="Editar">
            ...
            <form action="{{ route('dashboard.permissions.destroy', $permission->id) }}" method="POST" class="display-inline-block">
              ...
              <button type="submit" class="btn btn-link btn-sm c-666 p-0" data-toggle="tooltip" data-placement="top" title="Deletar">
