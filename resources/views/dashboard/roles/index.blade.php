...
<div class="container-fluid">
  ...
  <div class="d-flex justify-content-between mb-3">
    ...
    @can('manage roles')
    <div id="app">
      <modal title="New role" button-text="Nova role">
        <v-form inline-template route="/api/roles" success-message="Role criada!">
    ...
    <table class="table table-borderless fs-14 mb-0">
      ...
      <tbody>
        ...
        <tr scope="row">
          ...
          <td>
            {{-- Edit --}}
            <a href="{{ route('dashboard.roles.edit', $role->id) }}" class="btn btn-link btn-sm c-666 p-0" data-toggle="tooltip" data-placement="top" title="Editar">
