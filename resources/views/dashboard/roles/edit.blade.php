...
<div class="container-fluid">
    ...
    <h1 class="page-heading mb-3">Editar role - {{ $role->name }}</h1>
    ...
    <div class="row">
        <div class="col-6">
            <form action="{{ route('dashboard.roles.update', $role->id) }}" method="POST">
                ...
                <input type="submit" class="btn btn-primary" value="Atualizar role">
            </form>
        </div>
    </div>
</div>
...
<script>
  $(document).ready(function() {
    $('#permissions').select2({
      placeholder: 'Escolher permissões...'
  });
});
</script>
@endpush
