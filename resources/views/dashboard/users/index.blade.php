...
<div class="container-fluid">
  ...
  <div class="d-flex justify-content-between mb-3">
    <h1 class="page-heading">Usuários</h1>

    @can('manage users')
    <div id="app">
      <modal title="New user" button-text="Novo usuário">
        <v-form inline-template route="/api/users" success-message="Usuário criado!">
    ...
    <table class="table table-borderless fs-14 mb-0">
      ...
      <tbody>
        ...
        <tr scope="row">
          ...
          <td>
            <img src="{{ $armazenamento->url('public/avatars/' . $user->avatar) }}" style="width: 35px; height: 35px;">
          ...
          <td>
            {{-- Edit --}}
            <a href="{{ route('dashboard.users.edit', $user->id) }}" class="btn btn-link btn-sm c-666 p-0" data-toggle="tooltip" data-placement="top" title="Editar">
            ...
            <form action="{{ route('dashboard.users.destroy', $user->id) }}" method="POST" class="display-inline-block">
              ...
              <button class="btn btn-link btn-sm c-666 p-0" data-toggle="tooltip" data-placement="top" title="Excluir">
