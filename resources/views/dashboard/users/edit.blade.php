...
<div class="container-fluid">
    ...
    <h1 class="page-heading mb-4">
        ...
        Editar seu perfil
        @else
        Edit perfil de usuário - {{ $user->name }}
        @endif
    </h1>
    ...
    <div class="row">
        ...
        <div class="col col-md-3">
            ...
            <div class="list-group" id="list-tab" role="tablist">
                ...
                <a class="list-group-item list-group-item-action fs-14 @unless ($errors->password->any()) active @endunless" id="list-details-list" data-toggle="list" href="#list-details" role="tab" aria-controls="details">Detalhes da conta</a>

                <a class="list-group-item list-group-item-action fs-14 @if ($errors->password->any()) active @endif" id="list-password-list" data-toggle="list" href="#list-password" role="tab" aria-controls="password">Trocar senha</a>
            </div>
                    ...
                    <div class="row">
                        <div class="col col-lg-6 p-3">
                            ...
                            <form class="form" action="{{ route('dashboard.users.update', $user->id) }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <label for="avatar" class="custom-label">Imagem de perfil</label>


                                    <div id="image_container">

                                        <img src="{{ $armazenamento->url('public/avatars/' . $user->avatar) }}" id="image_preview" class="img-fluid display-block border mb-2">
                                ...
                                @endif
                                <input type="hidden" name="change_details" value="true">
                ...
                <div class="tab-pane fade" id="list-password" role="tabpanel" aria-labelledby="list-password-list">
                    <div class="col col-lg-6 p-3">
                        ...
                        <form class="form" action="{{ route('dashboard.users.update', $user->id) }}" method="POST">
                            ...
                            <div class="form-group">
                                <label for="current_password" class="custom-label">Senha atual</label>
                            ...
                            <div class="form-group">
                                <label for="password" class="custom-label">Nova senha</label>
                            ...
                            <div class="form-group">
                                <label for="password_confirmation" class="custom-label">Confirmar senha</label>
                            ...
                            <input type="submit" name="change_password" class="btn btn-sm btn-primary" value="Atualizar">
                        </form>
...
<script>
  ...
  document.getElementById('remove_image_button').addEventListener('click', function() {
    document.getElementById('image_preview').src = '{{ $armazenamento->url('public/avatars/'. App\User::DEFAULT_AVATAR) }}';
