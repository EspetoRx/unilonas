...
<div class="row">
    <div class="col-12 col-md-8 offset-md-2 col-lg-4 offset-lg-4">
        <div class="box-shadow border rounded my-5 p-3 text-center">
            <p class="font-weight-bold mb-4">{{ __('Registrar-se') }}</p>

            <form method="POST" action="{{ route('register') }}">
                @csrf

                <div class="form-group">
                    <label for="name" class="custom-label">{{ __('Nome') }}</label>
                ...
                <div class="form-group">
                    <label for="password-confirm" class="custom-label">{{ __('Repetir Senha') }}</label>
