<aside class="col-12 col-lg-4 sidebar mt-3 mt-lg-0 pl-lg-5 fs-14">
    ...
    <div class="display-block mb-4 mb-lg-5">
        <h5 class="sidebar-title mb-3">Categorias</h5>
    ...
    <div class="display-block mb-5">
        <h5 class="sidebar-title mb-3">Comentários recentes</h5>
        ...
        <ul class="list-unstyled mb-0">
            ...
            <li class="mb-2">
                ...
                em <a class="sidebar-link font-weight-bold" href="{{ route('posts.show', $comment->post->slug) }}#comment-{{ $comment->id }}">
                    {{ $comment->post->title }}
                </a>
